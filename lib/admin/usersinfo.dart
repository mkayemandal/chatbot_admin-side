...
class _UserinfoPageState extends State<UserinfoPage>
  ...
  bool get _allDataLoaded => _adminInfoLoaded && _userDataLoaded && _logoLoaded;
  ...
  int get prospectiveCount =>
      users.where((c) => c['position'] == 'Prospective').length;
  int get enrolledCount =>
      users.where((c) => c['position'] == 'Enrolled').length;
                ...
                builder: (context, constraints) {
                  ...
                  return Wrap(
                    ...
                    children: [
                      ...
                      StatCard(
                        title: "Prospective",
                        value: prospectiveCount.toString(),
                        color: primarycolor,
                        width: cardWidth,
                      ),
                      StatCard(
...
class HoverButton extends StatefulWidget {
  ...
  const HoverButton({Key? key, required this.onPressed, required this.child})
    : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isHovered
              ? primarycolordark.withOpacity(0.07)
              : Colors.transparent,
          borderRadius: BorderRadius.circular(8),
        ),
        child: TextButton(
